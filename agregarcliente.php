...
if($_SERVER['REQUEST_METHOD']=='POST'){
    ...
    $mensaje='';
    if(empty($Nombres) or empty($Tipo) or empty($Documento) or empty($Direccion) or empty($Telefono) or empty($Email)){
    ...
    if($mensaje==''){
        ...
        'INSERT INTO Clientes values(null, :Nombres, :Tipo, :Documento, :Direccion, :Telefono, :Email)');
                        ...
                        <div class="row page-title-header">
                            <div class="col-12">
                                <div class="page-header">
                                    <h4 class="page-title">Menú > Clientes > Nuevo Cliente</h4>
                                </div>
                            </div>
                        </div>
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-5">
                                                                    <div class="form-radio">
                                                                        <label class="form-check-label">
                                                                        <input type="radio" class="form-check-input" name="Tipo" value="Persona Juridica"> Persona Jurídica <i class="input-helper"></i></label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
